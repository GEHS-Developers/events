...
var advisor = $('#advisorid').val();
console.log(date);

window.location.href = "http://events.gibsonek.org/advisory.php?advisor="+advisor+"&date="+date+"";
...
<h1>Show my student's offerings on the week of:</h1>


<input type="hidden" name="advisor" id="advisorid" value=<?php echo $_GET['advisor']?>>
<input type="date" class="datepicker" id="datenow">
<a class="btn green" id="go">Go!</a>
